				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: (+62) 12345" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: (+62) 12345</a>
								</li>
							</ul>
						</div>
								...
								@if (Route::has('login'))
									@auth
										...
										<ul class="submenu curency" >
											...
											<li class="menu-item" >
												<a title="Logout" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout').submit();">Logout</a>
											</li>
										...
										@else
										<li class="menu-item menu-item-has-children parent" >
											<a title="My Account" href="{{ route('user.dashboard') }}">({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
										<ul class="submenu curency" >
											<li class="menu-item" >
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-logo-top left-section">
							<a href="/" class="link-to-home"><img src={{asset("assets/images/logo2.png")}}></a>
						</div>

						@livewire('header-searchc')
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">Malang, INA</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+62) 12345</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+62) 12345</b>
									</div>
								</div>
							</div>
